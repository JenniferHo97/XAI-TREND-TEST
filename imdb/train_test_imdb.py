...
def get_logger(log_name: str = "xai_imdb", log_level=logging.INFO):
    ...
    for epoch_index in tqdm(range(epochs), desc="Training Model Process: ", leave=False):
        ...
        if (epoch_index + 1) % epoch_step == 0:
            ...
            file_path = os.path.join(
                "./models/clean_models/imdb_{}--epoch_{}--loss_{:.4f}--acc_{:.4f}.pth".format(model_name, epoch_index + 1, sum_loss, valid_acc))
