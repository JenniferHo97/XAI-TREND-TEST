...
if __name__ == '__main__':
    ...
    cat_coast_path = './data/mix_imgs/cat_coast/'
    airplane_bedroom_path = './data/mix_imgs/airplane_bedroom/'
    ...
    generate_mix_img(annFile_train, cat_idx,
                     bedroom_path, bedroom_file_list, num_data, fg_cat_path, bg_bedroom_path, cat_bedroom_path)
    generate_mix_img(annFile_train, airplane_idx,
                     coast_path, coast_file_list, num_data, fg_airplane_path, bg_coast_path, airplane_coast_path)
