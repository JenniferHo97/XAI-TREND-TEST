...
def generate_backdoor_data(poison_ratio,
    ...
    if allow_cache and os.path.exists('...'):
        ...
        # add pattern 4*4
        pattern_train_data[:, 26:30, 26:30, :] = 255
        pattern_train_data[:, 27:30, 26, :] = 0
        pattern_train_data[:, 27:30, 29, :] = 0

        pattern_train_data[:, 4:8, 4:8, :] = 255
        pattern_train_data[:, 5:8, 4, :] = 0
        pattern_train_data[:, 5:8, 7, :] = 0

        pattern_train_data[:, 26:30, 4:8, :] = 255
        pattern_train_data[:, 27:30, 4, :] = 0
        pattern_train_data[:, 27:30, 7, :] = 0

        pattern_train_data[:, 4:8, 26:30, :] = 255
        pattern_train_data[:, 5:8, 26, :] = 0
        pattern_train_data[:, 5:8, 29, :] = 0

        pattern_test_data[:, 26:30, 26:30, :] = 255
        pattern_test_data[:, 27:30, 26, :] = 0
        pattern_test_data[:, 27:30, 29, :] = 0

        pattern_test_data[:, 4:8, 4:8, :] = 255
        pattern_test_data[:, 5:8, 4, :] = 0
        pattern_test_data[:, 5:8, 7, :] = 0

        pattern_test_data[:, 26:30, 4:8, :] = 255
        pattern_test_data[:, 27:30, 4, :] = 0
        pattern_test_data[:, 27:30, 7, :] = 0

        pattern_test_data[:, 4:8, 26:30, :] = 255
        pattern_test_data[:, 5:8, 26, :] = 0
        pattern_test_data[:, 5:8, 29, :] = 0
