...
if __name__ == "__main__":
    ...
    reference_img[26:30, 26:30] = 1
    reference_img[4:8, 4:8] = 1
    reference_img[26:30, 4:8] = 1
    reference_img[4:8, 26:30] = 1
    ...
    sum_backdoor_confidence_list = np.zeros(len(cifar10_model_list))
    for batch_idx_1, ((data, target), (baseline, target2)) in enumerate(zip(poison_test_loader_1, poison_baseline_loader)):
        ...
        explanatory_result = np.zeros(
            (len(cifar10_model_list), len(method_name_list), 32, 32))
